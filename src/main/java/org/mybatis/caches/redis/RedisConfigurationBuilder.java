    ...
    if (properties != null) {
      ...
      for (Map.Entry<Object, Object> entry : properties.entrySet()) {
        ...
        if ("serializer".equals(name)) {
          // if contains serializerClazz config , ignore serializer property
          if (!properties.containsKey("redis.serializerClazz")) {
        ...
        } else if ("serializerClazz".equals(name)) {
          if (value != null && !"".equals(value)) {
            ...
            if (clazz == null || !Serializer.class.isAssignableFrom(clazz)) {
              // if clazz is not assignableFrom serializer, use jdkSerializer for instead
